<x-app-layout>
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div class="relative bg-white p-6 rounded-2xl border border-slate-200 shadow-sm overflow-hidden group hover:border-red-300 transition-all cursor-pointer" onclick="window.location='{{ route('products.index') }}'">
                <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-xs text-slate-400 mt-1 group-hover:text-red-600">Perlu Restock Segera</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col h-full">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('reports.history') }}" class="text-xs font-bold text-indigo-600 hover:text-indigo-800 hover:underline">Semua</a>
                </div>
