    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-slate-500">Isi formulir di bawah untuk mendaftarkan pelanggan.</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" name="code" value="{{ old('code') }}" 
                                       class="w-full border-slate-300 rounded-lg text-sm focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-300 uppercase font-mono" 
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" 
                                       ...
                                       placeholder="Nama PT atau Perorangan" required>
                            ...
                            <div class="md:col-span-3">
                                ...
                                <textarea name="address" rows="3" 
                                          class="w-full border-slate-300 rounded-lg text-sm focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-300" 
                                          placeholder="Jalan, Kota, Provinsi, Kode Pos...">{{ old('address') }}</textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="phone" value="{{ old('phone') }}" 
                                           class="w-full pl-10 border-slate-300 rounded-lg text-sm focus:ring-indigo-500 focus:border-indigo-500 placeholder:text-slate-300" 
                                           placeholder="0812...">
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="p-4 bg-slate-50 rounded-lg border border-slate-200 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="payment_terms" class="w-full border-slate-300 rounded-lg text-sm focus:ring-emerald-500 focus:border-emerald-500">
                                    <option value="Cash" {{ old('payment_terms') == 'Cash' ? 'selected' : '' }}>Cash / Tunai</option>
                                    <option value="NET 7" {{ old('payment_terms') == 'NET 7' ? 'selected' : '' }}>Tempo 7 Hari (NET 7)</option>
                                    <option value="NET 14" {{ old('payment_terms') == 'NET 14' ? 'selected' : '' }}>Tempo 14 Hari (NET 14)</option>
                                    <option value="NET 30" {{ old('payment_terms') == 'NET 30' ? 'selected' : '' }}>Tempo 30 Hari (NET 30)</option>
                                    <option value="NET 60" {{ old('payment_terms') == 'NET 60' ? 'selected' : '' }}>Tempo 60 Hari (NET 60)</option>
                                </select>
                                <p class="text-xs text-slate-500 mt-1">Jatuh tempo default untuk invoice customer ini.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="credit_limit" value="{{ old('credit_limit') }}" 
                                           class="w-full pl-10 border-slate-300 rounded-lg text-sm font-bold text-slate-800 focus:ring-emerald-500 focus:border-emerald-500 placeholder:font-normal" 
                                           placeholder="0">
                                </div>
                                <div class="flex items-start gap-1 mt-2">
                                    ...
                                    <p class="text-xs text-slate-500 leading-tight">
                                        ...
                                        Jika piutang melebihi nilai ini, order baru akan otomatis <strong>ON HOLD</strong>.
                                    </p>
                                </div>
                            </div>
                        </div>
